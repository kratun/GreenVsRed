...
<doc>
    ...
    <members>
        ...
        <!-- Badly formed XML comment ignored for member "F:GreenVsRed.Common.Constants.GeneralConstants.EnterMatrix" -->
        <!-- Badly formed XML comment ignored for member "F:GreenVsRed.Common.Constants.GeneralConstants.EnterMatrixRow" -->
